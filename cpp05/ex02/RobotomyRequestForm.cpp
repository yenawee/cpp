...
RobotomyRequestForm::RobotomyRequestForm(void) :AForm("RR", RR_SIGN_GRADE, RR_EXEC_GRADE), target("default") 
{ 
    // std::cout << "RobotomyRequestForm created. Default." << std::endl; 
}

RobotomyRequestForm::RobotomyRequestForm(const std::string & target) :AForm("RR", RR_SIGN_GRADE, RR_EXEC_GRADE), target(target) 
{ 
